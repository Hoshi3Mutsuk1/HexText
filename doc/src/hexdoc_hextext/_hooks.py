...
import hexdoc_hextext

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HextextPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HextextModPlugin(branch=branch)


class HextextModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hextext"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hextext, "_templates"
